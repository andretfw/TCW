...
import { Facebook, Instagram, Twitter, Mail, MapPin, Heart, FileText, Award, Star } from 'lucide-react';
          ...
          <div className="space-y-6">
            <Link href={`${prefix}/`} className="block">
                <div className="relative h-48 w-full max-w-md"> 
                    <Image src="/TCW_LOGO.png" alt="Tutti Cancer Warriors" fill className="object-contain brightness-0 invert opacity-90 hover:opacity-100 transition-opacity" />
                </div>
            </Link>
            ...
            <div className="pt-6 border-t border-neutral-800 mt-6">
                <p className="text-xs text-neutral-500 font-bold uppercase tracking-wider mb-3">{t('verified')}</p>
                <div className="flex items-center gap-4">
                    <a href="https://www.kraken.com/" target="_blank" rel="noopener noreferrer" className="block transition-transform hover:scale-105">
                        <div className="relative h-14 w-14 rounded-full overflow-hidden border border-neutral-700 bg-white"><Image src="/kraken-badge.jpg" alt="Kraken Verified" fill className="object-cover" /></div>
                    </a>
                    <a href="https://www.worldpatientsalliance.org/" target="_blank" rel="noopener noreferrer" className="block transition-transform hover:scale-105">
                        <div className="relative h-14 w-14"><Image src="/wpa-logo.png" alt="WPA Member" fill className="object-contain" /></div>
                    </a>
                </div>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20">
                ...
                <div className="text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <div className="flex items-center gap-10">
                        ...
                        {/* GT LOGO: Ahora te lleva a su web oficial */}
                        <a href="https://www.gtracemarbella.com/" target="_blank" rel="noopener noreferrer" className="cursor-pointer group relative h-20 w-32 transition-all duration-300 opacity-80 group-hover:opacity-100 mix-blend-screen group-hover:scale-110">
                            <Image src="/gt-logo.jpg" alt="GT Race Sponsor" fill className="object-contain" />
                        </a>
                        
                        {/* TFW LOGO: Altura corregida a h-20 (antes h-18) para que vuelva a aparecer */}
                        <a href="/tfw-logo.png" target="_blank" rel="noopener noreferrer" className="cursor-pointer group relative h-20 w-32 transition-all duration-300 opacity-80 group-hover:opacity-100 grayscale-0 brightness-110 group-hover:scale-110">
