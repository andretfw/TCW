...
const COPY = {
  en: {
    ...
    subtitle: 'TCW privately matches adults living with cancer with survivors who have relevant lived experience. After both people accept, TCW offers three shared times and creates a private Google Meet only when they confirm the same one.',
    ...
    steps: [
      ...
      ['Meet after mutual consent', 'Both people accept, choose from three shared times and confirm the same one before TCW creates a Google Meet.'],
    ],
    ...
    capacity: 'How many warriors can you support at one time?', mentorPreference: 'Preferred survivor gender', communication: 'Preferred communication', availabilityHelp: 'Choose every time window that usually works. TCW will offer three shared 45-minute options.', timezone: 'Detected time zone',
    ...
    consentMeeting: 'I consent to TCW offering shared meeting times and creating a private Google Meet only after we both confirm the same option.',
  ...
  ro: {
    ...
    subtitle: 'TCW conectează în mod privat adulții care trăiesc cu cancer cu supraviețuitori care au o experiență relevantă. După ce ambele persoane acceptă, TCW oferă trei intervale comune și creează un Google Meet privat numai când amândoi confirmă același interval.',
    ...
    steps: [
      ...
      ['Vă întâlniți după acceptul reciproc', 'Ambele persoane acceptă, aleg dintre trei intervale comune și confirmă același interval înainte ca TCW să creeze un Google Meet.'],
    ],
    ...
    capacity: 'Câți luptători poți sprijini în același timp?', mentorPreference: 'Genul preferat al supraviețuitorului', communication: 'Metoda de comunicare preferată', availabilityHelp: 'Alege intervalele care îți sunt de obicei potrivite. TCW va oferi trei opțiuni comune de câte 45 de minute.', timezone: 'Fus orar detectat',
    ...
    consentMeeting: 'Consimt ca TCW să ne ofere intervale comune și să creeze un Google Meet privat numai după ce confirmăm amândoi aceeași opțiune.',
  ...
  es: {
    ...
    subtitle: 'TCW conecta de forma privada a adultos que viven con cáncer con supervivientes con experiencia relevante. Después de que ambas personas acepten, TCW ofrece tres horarios comunes y crea un Google Meet privado solo cuando ambas confirman el mismo.',
    ...
    steps: [
      ...
      ['Reuníos con consentimiento mutuo', 'Ambas personas aceptan, eligen entre tres horarios comunes y confirman el mismo antes de que TCW cree un Google Meet.'],
    ],
    ...
    capacity: '¿A cuántas personas puedes apoyar al mismo tiempo?', mentorPreference: 'Género preferido del superviviente', communication: 'Comunicación preferida', availabilityHelp: 'Elige los horarios que normalmente te sirven. TCW ofrecerá tres opciones comunes de 45 minutos.', timezone: 'Zona horaria detectada',
    ...
    consentMeeting: 'Acepto que TCW ofrezca horarios comunes y cree un Google Meet privado solo después de que ambas personas confirmemos la misma opción.',
