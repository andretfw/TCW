...
const COPY = {
  en: {
    ...
    session: 'After opening the link, this device stays signed in for 30 days unless you log out.',
  ...
  ro: {
    ...
    session: 'După deschiderea linkului, rămâi autentificat pe acest dispozitiv timp de 30 de zile, dacă nu te deconectezi.',
  ...
  es: {
    ...
    session: 'Después de abrir el enlace, este dispositivo mantiene la sesión durante 30 días salvo que cierres sesión.',
